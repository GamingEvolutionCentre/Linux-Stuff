...
install_dependencies_macos() {
	...
	prepare_bash_completion_macos
	brew_install_missing bash bash-completion@2 bat tree multitail fastfetch neovim trash fzf zoxide
...
print_colored "$GREEN" "Installation complete. Restart your shell or run: source ~/.config/bash/.bashrc"
