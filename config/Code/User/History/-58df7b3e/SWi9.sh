...
echo "-> alpha-nvim"
git clone --depth 1 "https://github.com/goolord/alpha-nvim.git" "$PLUGINSalpha-nvim"
rm -rf "$PLUGINS/alpha-nvim/.git"

echo "-> mini.icons"
git clone --depth 1 "https://github.com/nvim-mini/mini.icons.git" "$PLUGINSmini.icons"
